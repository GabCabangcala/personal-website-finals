<!-- filepath: /workspaces/personal-website-finals/firstsfc/src/components/Music.vue -->
<template>
  <section id="music-section" class="music-section" data-aos="fade-right" data-aos-anchor-placement="top-bottom">
    <div class="container">
      ...
      <ul class="cards">
        <li>
          <img src="path/to/album-cover1.jpg" width="600" height="600" alt="Album Cover 1">
          <audio src="path/to/audio1.mp3"></audio>
        </li>
        <li>
          <img src="path/to/album-cover2.jpg" width="600" height="600" alt="Album Cover 2">
          <audio src="path/to/audio2.mp3"></audio>
        </li>
        <li>
          <img src="path/to/album-cover3.jpg" width="600" height="600" alt="Album Cover 3">
          <audio src="path/to/audio3.mp3"></audio>
        </li>
      </ul>
    </div>
  </section>
